...
class Bank
{
    ...
    static void InitializeDummyAccounts()
    {
        ...
        BankAccount dummyAccount1 = new BankAccount("Shubham", 123456789, 1, 150000);
        accounts.Add(dummyAccount1);

        BankAccount dummyAccount2 = new BankAccount("Rohit", 987654321, 2, 180000);
        accounts.Add(dummyAccount2);

	BankAccount dummyAccount3 = new BankAccount("Virat", 012345678, 3, 260000);
